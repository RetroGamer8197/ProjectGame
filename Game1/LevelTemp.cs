...
namespace Game1
{
    ...
    public abstract class LevelTemp
    {
        ...
        public static Level QuakeReturn()
        {
            ...
            levelStore.levelObjects.Add(new Triangle((-2.0f, 1.75f, 2.5f), (-1.5f, 2.25f, 2.5f), (-1.5f, 1.75f, 2.5f), [(0.5f, 0.0f), (0.75f, 0.25f), (0.75f, 0.0f)], 0.8f));
            levelStore.levelObjects.Add(new Triangle((-2.0f, 1.75f, 3.5f), (-1.5f, 2.25f, 3.5f), (-1.5f, 1.75f, 3.5f), [(0.5f, 0.0f), (0.75f, 0.25f), (0.75f, 0.0f)], 0.8f));

            levelStore.levelObjects.Add(new Triangle((-2.5f, 1.25f, 2.5f), (-2.0f, 1.75f, 2.5f), (-2.0f, 1.25f, 2.5f), [(0.5f, 0.0f), (0.75f, 0.25f), (0.75f, 0.0f)], 0.8f));
            levelStore.levelObjects.Add(new Triangle((-2.5f, 1.25f, 3.5f), (-2.0f, 1.75f, 3.5f), (-2.0f, 1.25f, 3.5f), [(0.5f, 0.0f), (0.75f, 0.25f), (0.75f, 0.0f)], 0.8f));
